...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_step_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f42d8721#;
   pragma Export (C, u00001, "psx_cpu_step_testsB");
   ...
   u00115 : constant Version_32 := 16#b71a1818#;
   pragma Export (C, u00115, "psx__cpu__fetchB");
   u00116 : constant Version_32 := 16#abd2136c#;
   pragma Export (C, u00116, "psx__cpu__fetchS");
   u00117 : constant Version_32 := 16#e0adb4c5#;
   pragma Export (C, u00117, "psx__cpu__instructionB");
   u00118 : constant Version_32 := 16#539b7d3d#;
   pragma Export (C, u00118, "psx__cpu__instructionS");
   u00119 : constant Version_32 := 16#3c9f460e#;
   pragma Export (C, u00119, "psx__memoryB");
   u00120 : constant Version_32 := 16#3c7da857#;
   pragma Export (C, u00120, "psx__memoryS");
   u00121 : constant Version_32 := 16#45bfb273#;
   pragma Export (C, u00121, "ada__streams__stream_ioB");
   u00122 : constant Version_32 := 16#44ae819b#;
   ...
   u00124 : constant Version_32 := 16#c51bd61d#;
   pragma Export (C, u00124, "system__communicationS");
   u00125 : constant Version_32 := 16#b3661e81#;
   pragma Export (C, u00125, "psx__cdromB");
   u00126 : constant Version_32 := 16#798e0f1f#;
   pragma Export (C, u00126, "psx__cdromS");
   u00127 : constant Version_32 := 16#f04521cd#;
   pragma Export (C, u00127, "psx__sioB");
   u00128 : constant Version_32 := 16#fbaf5645#;
   pragma Export (C, u00128, "psx__sioS");
   u00129 : constant Version_32 := 16#5bdae43b#;
   pragma Export (C, u00129, "psx__timersB");
   u00130 : constant Version_32 := 16#ab19291a#;
   pragma Export (C, u00130, "psx__timersS");
   u00131 : constant Version_32 := 16#19da7f2d#;
   pragma Export (C, u00131, "psx__cpu__stepB");
   u00132 : constant Version_32 := 16#df77dbaf#;
   pragma Export (C, u00132, "psx__cpu__stepS");
   u00133 : constant Version_32 := 16#f8bbf887#;
   pragma Export (C, u00133, "psx__cpu__cyclesB");
   u00134 : constant Version_32 := 16#cb6afad2#;
   pragma Export (C, u00134, "psx__cpu__cyclesS");
   u00135 : constant Version_32 := 16#99aa6487#;
   pragma Export (C, u00135, "psx__cpu__executeB");
   u00136 : constant Version_32 := 16#fb615733#;
   pragma Export (C, u00136, "psx__cpu__executeS");
   u00137 : constant Version_32 := 16#d8d6aee0#;
   pragma Export (C, u00137, "psx__cpu__muldivB");
   u00138 : constant Version_32 := 16#de939a6a#;
   pragma Export (C, u00138, "psx__cpu__muldivS");
   u00139 : constant Version_32 := 16#79ef05bb#;
   pragma Export (C, u00139, "psx__memory__cyclesB");
   u00140 : constant Version_32 := 16#90d5150a#;
   pragma Export (C, u00140, "psx__memory__cyclesS");
   u00141 : constant Version_32 := 16#95493cea#;
   pragma Export (C, u00141, "psx__dmaB");
   u00142 : constant Version_32 := 16#7ac6e11e#;
   pragma Export (C, u00142, "psx__dmaS");
   u00143 : constant Version_32 := 16#957a60cd#;
   pragma Export (C, u00143, "psx__gpuB");
   u00144 : constant Version_32 := 16#cd1b16df#;
   pragma Export (C, u00144, "psx__gpuS");
   u00145 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00145, "system__memoryB");
   u00146 : constant Version_32 := 16#92f586d9#;
