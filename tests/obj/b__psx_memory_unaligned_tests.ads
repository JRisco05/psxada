...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_memory_unaligned_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4496bd42#;
   pragma Export (C, u00001, "psx_memory_unaligned_testsB");
