...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_memory_load_cycle_count_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1d45c577#;
   pragma Export (C, u00001, "psx_memory_load_cycle_count_testsB");
   ...
   u00145 : constant Version_32 := 16#d13cd62d#;
   pragma Export (C, u00145, "system__img_unsS");
   u00146 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00146, "system__memoryB");
   u00147 : constant Version_32 := 16#92f586d9#;
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_memory_load_cycle_count_tests%b
