...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_memory_load_all_cycle_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#571cb0f8#;
   pragma Export (C, u00001, "psx_memory_load_all_cycle_testsB");
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_memory_load_all_cycle_tests%b
