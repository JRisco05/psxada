...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#de8742d2#;
   ...
   u00127 : constant Version_32 := 16#bfd16bc8#;
   pragma Export (C, u00127, "psx__cpu__fetchB");
   u00128 : constant Version_32 := 16#3d4e65f6#;
