...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_saturation_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#42940776#;
   pragma Export (C, u00001, "psx_gte_saturation_testsB");
   ...
   u00117 : constant Version_32 := 16#016443a6#;
   pragma Export (C, u00117, "psx__gte__execute__saturationB");
   u00118 : constant Version_32 := 16#6d23305d#;
   pragma Export (C, u00118, "psx__gte__execute__saturationS");
   u00119 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00119, "system__memoryB");
   u00120 : constant Version_32 := 16#92f586d9#;
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx.gte.execute.saturation%s
   --  psx.gte.execute.saturation%b
   --  psx_gte_saturation_tests%b
