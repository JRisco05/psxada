...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_mvmva_ir_negative_saturation_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7ecbbd9c#;
   pragma Export (C, u00001, "psx_gte_mvmva_ir_negative_saturation_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_mvmva_ir_negative_saturation_tests%b
