...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_nclip_negative_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b4eda916#;
   pragma Export (C, u00001, "psx_gte_nclip_negative_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_nclip_negative_tests%b
