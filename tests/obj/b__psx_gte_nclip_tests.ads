...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_nclip_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#131c0ef7#;
   pragma Export (C, u00001, "psx_gte_nclip_testsB");
