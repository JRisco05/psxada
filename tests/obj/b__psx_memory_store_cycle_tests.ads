...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_memory_store_cycle_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#301b1066#;
   pragma Export (C, u00001, "psx_memory_store_cycle_testsB");
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_memory_store_cycle_tests%b
