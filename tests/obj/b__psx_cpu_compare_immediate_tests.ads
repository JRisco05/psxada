...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_compare_immediate_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#51ab669e#;
   pragma Export (C, u00001, "psx_cpu_compare_immediate_testsB");
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_cpu_compare_immediate_tests%b
