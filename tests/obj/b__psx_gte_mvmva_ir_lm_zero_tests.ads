...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_mvmva_ir_lm_zero_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5bee52cb#;
   pragma Export (C, u00001, "psx_gte_mvmva_ir_lm_zero_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_mvmva_ir_lm_zero_tests%b
