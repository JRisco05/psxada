...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_dma_register_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d4a559c3#;
   pragma Export (C, u00001, "psx_dma_register_testsB");
