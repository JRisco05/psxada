...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gpu_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d360187c#;
   ...
   u00110 : constant Version_32 := 16#08d6e36b#;
   pragma Export (C, u00110, "psx__gpuB");
   u00111 : constant Version_32 := 16#1d14801a#;
