...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_avsz3_overflow_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#79199072#;
   pragma Export (C, u00001, "psx_gte_avsz3_overflow_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_avsz3_overflow_tests%b
