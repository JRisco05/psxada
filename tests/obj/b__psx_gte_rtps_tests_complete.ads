...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_rtps_tests_complete" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#33f3ce78#;
   pragma Export (C, u00001, "psx_gte_rtps_tests_completeB");
