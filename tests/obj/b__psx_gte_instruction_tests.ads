...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_instruction_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#cc1ae99a#;
   pragma Export (C, u00001, "psx_gte_instruction_testsB");
   ...
   u00113 : constant Version_32 := 16#fece5866#;
   pragma Export (C, u00113, "psx__gte__instructionB");
   u00114 : constant Version_32 := 16#9cf88e23#;
   pragma Export (C, u00114, "psx__gte__instructionS");
   u00115 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00115, "system__memoryB");
   u00116 : constant Version_32 := 16#92f586d9#;
