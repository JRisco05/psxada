...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_mvmva_mac_negative_overflow_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#acb4e6da#;
   pragma Export (C, u00001, "psx_gte_mvmva_mac_negative_overflow_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_mvmva_mac_negative_overflow_tests%b
