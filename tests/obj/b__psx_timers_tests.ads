...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_timers_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#61b8256f#;
   pragma Export (C, u00001, "psx_timers_testsB");
   ...
   u00124 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00124, "system__memoryB");
   u00125 : constant Version_32 := 16#92f586d9#;
