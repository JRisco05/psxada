...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_memory_load_timing_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#161c3efd#;
   pragma Export (C, u00001, "psx_memory_load_timing_testsB");
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_memory_load_timing_tests%b
