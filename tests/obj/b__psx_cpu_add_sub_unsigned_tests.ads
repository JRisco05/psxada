...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_add_sub_unsigned_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e9e1bf0c#;
   pragma Export (C, u00001, "psx_cpu_add_sub_unsigned_testsB");
   ...
   --  psx.cpu.step%s
   --  psx.cpu.step%b
   --  psx_cpu_add_sub_unsigned_tests%b
