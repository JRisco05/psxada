...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_nclip_positive_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#79fb62d5#;
   pragma Export (C, u00001, "psx_gte_nclip_positive_testsB");
   ...
   --  psx.gte.execute%s
   --  psx.gte.execute%b
   --  psx_gte_nclip_positive_tests%b
