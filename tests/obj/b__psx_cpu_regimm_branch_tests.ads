...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_regimm_branch_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#88083615#;
   pragma Export (C, u00001, "psx_cpu_regimm_branch_testsB");
