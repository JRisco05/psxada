...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_lwl_lwr_delay_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e008fa2e#;
   pragma Export (C, u00001, "psx_cpu_lwl_lwr_delay_testsB");
