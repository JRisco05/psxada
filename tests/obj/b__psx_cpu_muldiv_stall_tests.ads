...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_cpu_muldiv_stall_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#404cbf86#;
   pragma Export (C, u00001, "psx_cpu_muldiv_stall_testsB");
