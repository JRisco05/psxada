...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_data_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fa316cc5#;
   pragma Export (C, u00001, "psx_gte_data_testsB");
