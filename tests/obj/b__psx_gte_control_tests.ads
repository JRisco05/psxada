...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_control_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e29fd0db#;
   pragma Export (C, u00001, "psx_gte_control_testsB");
