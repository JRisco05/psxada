...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_mvmva_sf0_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d51d1221#;
   pragma Export (C, u00001, "psx_gte_mvmva_sf0_testsB");
