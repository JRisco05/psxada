...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_psx_gte_avsz4_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6a0dc530#;
   pragma Export (C, u00001, "psx_gte_avsz4_testsB");
