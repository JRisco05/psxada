pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__psx_gte_mvmva_mac_negative_overflow_tests.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__psx_gte_mvmva_mac_negative_overflow_tests.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_psx_gte_mvmva_mac_negative_overflow_tests");
...
--  BEGIN Object file/option list
   ...
   --   /Users/jonathanrisco/Projects/Ada/PSXADA/psxada/tests/obj/psx_gte_mvmva_mac_negative_overflow_tests.o
