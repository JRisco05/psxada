...
procedure PSX_CPU_Add_Sub_Unsigned_Tests is
...
begin
   ...
   Put_Line ("Testing PSX CPU unsigned arithmetic instructions...");
   New_Line;
   ...
   PSX.Memory.Write_32 (Memory, 16#0001_0000#, 16#0022_18_21#);
   ...
   PSX.Memory.Write_32 (Memory, 16#0001_0000#, 16#0022_18_23#);
   ...
   Check ("SUBU", 16#FFFF_FFFF#, CPU.Registers (3));

   Put_Line ("");
   Put_Line ("PSX CPU unsigned arithmetic tests finished.");

end PSX_CPU_Add_Sub_Unsigned_Tests;
