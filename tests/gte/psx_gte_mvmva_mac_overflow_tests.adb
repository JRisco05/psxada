...
procedure PSX_GTE_MVMVA_MAC_Overflow_Tests is
...
begin
   Put_Line ("Testing PSX GTE MVMVA MAC overflow...");
   ...
   Put_Line ("PSX GTE MVMVA MAC overflow tests finished.");

end PSX_GTE_MVMVA_MAC_Overflow_Tests;
